...
public class RegistrasiActivity extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.blokirpinjol.testlks.R.layout.activity_registrasi);
        App.setmContext(this);
        btnRegis = (Button)findViewById(com.blokirpinjol.testlks.R.id.btnRegis);
        txtUsername = (EditText)findViewById(com.blokirpinjol.testlks.R.id.txtUsername);
        txtPassword = (EditText)findViewById(com.blokirpinjol.testlks.R.id.txtPassword);
        txtPasswordConfirm = (EditText)findViewById(com.blokirpinjol.testlks.R.id.txtPasswordConfirm);
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.btnRegis: /** Start a new Activity MyCards.java */
